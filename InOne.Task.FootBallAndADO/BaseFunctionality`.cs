...
{
    public abstract class BaseFunctionality<TEntity> : BaseFunctionality, IBaseRepository<TEntity>
        where TEntity : class, new()
    {
        protected BaseFunctionality(DbContext dbContext) : base(dbContext) { }
